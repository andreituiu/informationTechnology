...
public class CreateUser extends JFrame {
	...
	public void initialize() {
		...
		passwordTextField.setText("Autogenerated");
		...
		cnpTextField.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				adminCreateUserController.updateInternalEmail();
			}
	...
	public void setLanguageBundle(ResourceBundle languageBundle) {
		...
		passwordTextField.setText(languageBundle.getString("autogenerated"));
	...
	public void setInternalEmail(String generatedInternalEmail) {
		internalEmailTextField.setText(generatedInternalEmail);
	}
}
