...
public class Course implements Serializable {
	...
	@JoinTable(name = "course_student_enrolled", joinColumns = {
			@JoinColumn(name = "course_id") }, inverseJoinColumns = { @JoinColumn(name = "student_cnp") })
	private Set<Student> enrolledStudents;

	@ManyToMany(fetch = FetchType.EAGER)
	@JoinTable(name = "course_student_pending", joinColumns = {
			@JoinColumn(name = "course_id") }, inverseJoinColumns = { @JoinColumn(name = "student_cnp") })
